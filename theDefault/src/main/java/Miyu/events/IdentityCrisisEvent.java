...
import static Miyu.DefaultMod.makeEventPath;

public class IdentityCrisisEvent
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    case 0: // If you press button the first button (Button at index 0), in this case: Inspiration.
                        ...
                        // we'll still continue the switch (screenNum) statement. It'll find screen 1 and do it's
                        // actions
                    ...
                    case 1: // If you press button the second button (Button at index 1), in this case: Denial
                        ...
                        // (etc.)
                        // And that would also just set them into slot 0, 1, 2... in order, just like what we do in the
                        // very beginning
                    ...
                    case 3: // If you press button the fourth button (Button at index 3), in this case: TOUCH
                        imageEventText.loadImage("MiyuResources/images/events/IdentityCrisisEvent2.png"); // Change the
                                                                                                          // shown
                                                                                                          // image
    ...
    public void update() { // We need the update() when we use grid screens (such as, in this case, the screen for
                           // selecting a card to remove)
