...
public class NextTarget extends AbstractDynamicCard {
	...
	public static final String ID = DefaultMod.makeID(NextTarget.class.getSimpleName()); // USE THIS ONE FOR THE
																							// TEMPLATE;
	public static final String IMG = makeCardPath("NextTarget.png");// "public static final String IMG =
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		...
		this.addToBot(
				new NextTargetAction(m, new DamageInfo(p, this.damage, this.damageTypeForTurn), this.magicNumber));
