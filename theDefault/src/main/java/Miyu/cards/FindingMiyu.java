...
public class FindingMiyu
    extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(FindingMiyu.class.getSimpleName()); // USE THIS ONE FOR THE
                                                                                          // TEMPLATE;

    public static final String IMG = makeCardPath("FindingMiyu.png");// "public static final String IMG =
