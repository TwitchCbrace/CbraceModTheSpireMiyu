...
public class RabbitType39Rifle extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(RabbitType39Rifle.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("RabbitType39Rifle.png");// "public static final String IMG = makeCardPath("PebbleMagic.png");
