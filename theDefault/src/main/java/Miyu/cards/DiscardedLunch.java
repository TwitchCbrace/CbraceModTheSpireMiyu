...
public class DiscardedLunch
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager
            .addToBottom(new ApplyPowerAction(p, p, new TrashPower(p, p, coverMagicNumber), coverMagicNumber));
        AbstractDungeon.actionManager
            .addToBottom(new ApplyPowerAction(p, p, new VigorPower(p, coverMagicNumber), coverMagicNumber));
