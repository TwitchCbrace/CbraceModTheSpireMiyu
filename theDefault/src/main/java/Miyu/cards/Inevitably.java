...
public class Inevitably extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Inevitably.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("Inevitably.png");// "public static final String IMG = makeCardPath("Inevitably.png");
...
//            stopGlowing();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new DamageAction(m, new DamageInfo(p, this.damage, damageTypeForTurn), AbstractGameAction.AttackEffect.BLUNT_HEAVY, true));
    }
