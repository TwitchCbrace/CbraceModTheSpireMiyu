...
public class IamHere extends AbstractDynamicCard {
	...
	public static final String IMG = makeCardPath("IamHere.png");// "public static final String IMG =
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		...
		AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new PresencePower(p, p, -20)));
