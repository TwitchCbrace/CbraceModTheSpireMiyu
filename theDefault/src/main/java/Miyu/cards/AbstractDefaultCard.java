...
public abstract class AbstractDefaultCard extends CustomCard {
    ...
    public void displayUpgrades() { // Display the upgrade - when you click a card to upgrade it
        ...
        if (upgradedRangeMagicNumber) { // If we set upgradedDefaultSecondMagicNumber = true in our card.
            rangeMagicNumber = baseRangeMagicNumber; // Show how the number changes, as out of combat, the base number of a card is shown.
            isRangeMagicNumberModified = true; // Modified = true, color it green to highlight that the number is being changed.
        }
