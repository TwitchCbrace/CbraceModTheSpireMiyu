...
public class PalePresence extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(PalePresence.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("PalePresence.png");// "public static final String IMG = makeCardPath("PebbleMagic.png");
