...
public class BottledPlaceholderField {
	...
	// In this scenario we're going to add a boolean named "inBottledPlaceholderField" to the "makeStatEquivalentCopy"
	// method inside AbstractCard
