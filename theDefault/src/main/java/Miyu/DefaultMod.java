...
import Miyu.relics.BottledPlaceholderRelic;
...
public class DefaultMod
    ...
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT =
        "MiyuResources/images/1024/card_default_gray_orb.png";
    ...
    public static final String THE_DEFAULT_SKELETON_JSON =
        "MiyuResources/images/char/defaultCharacter/Spriter/Miyustand.json";
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        IDCheckDontTouchPls EXCEPTION_STRINGS =
            coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // OR THIS,
                                                                                                          // DON'T EDIT
                                                                                                          // IT
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = DefaultMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT
                                                                                                       // THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS =
            coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO
                                                                                                          // EDIT
    ...
    public void receivePostInitialize() {
        ...
        ModLabeledToggleButton enableNormalsButton =
            new ModLabeledToggleButton("This is the text which goes next to the checkbox.", 350.0f, 700.0f,
                Settings.CREAM_COLOR, FontHelper.charDescFont, // Position (trial and error it), color, font
                ...
                (button) -> { // The actual button:
                    ...
                    try {
                        ...
                        SpireConfig config =
                            new SpireConfig("defaultMod", "theDefaultConfig", theDefaultDefaultSettings);
    ...
    public void receiveEditKeywords() {
        ...
        com.evacipated.cardcrawl.mod.stslib.Keyword[] keywords =
            gson.fromJson(json, com.evacipated.cardcrawl.mod.stslib.Keyword[].class);
