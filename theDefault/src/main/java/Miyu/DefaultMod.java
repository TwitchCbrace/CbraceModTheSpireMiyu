...
public class DefaultMod implements
    ...
    public DefaultMod() {
      ...
      */
        ...
        BaseMod.addColor(TheDefault.Enums.COLOR_GRAY, DODGE_BLUE, DODGE_BLUE, DODGE_BLUE,
                DODGE_BLUE, DODGE_BLUE, DODGE_BLUE, DODGE_BLUE,
...
//        BaseMod.addDynamicVariable(new DefaultCustomVariable());
        ...
        new AutoAdd("Miyu") // ${project.artifactId}
            .packageFilter("Miyu.cards") // filters to any class in the same package as AbstractDefaultCard, nested packages included
            .setDefaultSeen(true)
            .cards();
 ...
 */
        BaseMod.loadCustomStringsFile(UIStrings.class,
                pathByLanguage + "DefaultMod-Ui-Strings.json");
