...
public class TextureLoader {
    ...
    /**
     * @param textureString
     *            - String path to the texture you want to load relative to resources, Example:
    ...
    public static Texture getTexture(final String textureString) {
        if (textures.get(textureString) == null) {
            try {
                ...
                return getTexture("MiyuResources/images/ui/missing_texture.png");
            }
        }
