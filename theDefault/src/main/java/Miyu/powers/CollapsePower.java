...
public class CollapsePower extends AbstractPower implements CloneablePowerInterface, OnReduceCover {
	...
	// file.
	private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("CollapsePower84.png"));
	private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("CollapsePower32.png"));
