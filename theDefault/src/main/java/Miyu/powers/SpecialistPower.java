...
public class SpecialistPower extends AbstractPower implements CloneablePowerInterface {
	...
	public static final String POWER_ID = DefaultMod.makeID("SpecialistPower");
	...
	// file.
	private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("SpecialistPower84.png"));
	private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("SpecialistPower32.png"));

	public SpecialistPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
		name = NAME;
		ID = POWER_ID;
	...
	public AbstractPower makeCopy() {
		return new SpecialistPower(owner, source, amount);
	}
}
