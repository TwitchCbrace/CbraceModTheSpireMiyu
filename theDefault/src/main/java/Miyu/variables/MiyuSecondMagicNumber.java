...
public class MiyuSecondMagicNumber extends DynamicVariable {
    ...
    @Override
    public boolean upgraded(AbstractCard card) { return ((AbstractDefaultCard) card).upgradedSecondMagicNumber; }
}