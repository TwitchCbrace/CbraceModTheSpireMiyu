...
public class DummyCoverSelectAction extends AbstractGameAction {
    ...
    /*
uistring을 확장하였음.
추가된 uistring은 localization 폴더에 다른 애들처럼 같이 있음
by josh
 */
...
지정된 duration이 지난 후
손 패 목록을 가져와서
ICoverCard interface를 따르는 카드만 추려서 목록에 넣음
 ...
 */
            ...
            /*
카드가 없거나 지정된 장수보다 적으면 trigger 호출하고
그걸로 선택 종료
by josh
 */
            ...
            /*
지정된 조건 ICoverCard interface를 따르는 녀석들이 들어있는 cardsHasCover를 보내서
카드 선택 팝업 띄움
gridSelectScreen은 커스텀 카드 목록으로 카드 선택할 수 있도록 팝업을 띄우는 클래스
 ...
 */
        ...
        /*
카드가 선택 됐으면 각 카드의 trigger 실행하고 선택 종료
by josh
 */
